      ...
      <div style={{ padding: '20px' }}>
        ...
        <div style={{ marginTop: '40px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}> 
          ...
          <div className='table-container'>
              ...
              <div className="product-table" style={{ display: 'grid', gridTemplateColumns: `150px repeat(${products.length}, 1fr)`, gap: '10px', textAlign: 'center', border: '2px solid #ddd', borderRight: 'none' }}>
